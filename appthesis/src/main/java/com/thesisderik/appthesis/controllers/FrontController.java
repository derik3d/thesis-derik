...
public class FrontController {
	...
	@RequestMapping("nodeDescription/{nodeName}")
    public String nodeDescription(@PathVariable(name = "nodeName") String nodeName, Model model){
		model.addAttribute("nodeData", iSimpleGraphManager.getSimpleNodeDataFormat(nodeName));
        return "fragments/nodeData";
    }
